...
//        Model com.chefSearch.model = ModelFactory.createDefaultModel();
//
//        RDFParser.source(URL).httpAccept("text/turtle").parse(com.chefSearch.model.getGraph());
//
//        String resURL = URL.replace("data", "resource");
//        URL = URL.replace(chef, "XXX");
//        resURL = resURL.replace(".ttl", "");
//
//        Resource chefResource = com.chefSearch.model.getResource(resURL);
//
...
//
//        /* BOOKS */
//        Property bookProperty = com.chefSearch.model.getProperty("http://dbpedia.org/ontology/author");
//        ResIterator bookIterator = com.chefSearch.model.listSubjectsWithProperty(bookProperty);
...
//
//        /* TV SHOWS */
//        Property propertyStarring = com.chefSearch.model.getProperty("http://dbpedia.org/ontology/starring");
//        ResIterator tvShowIterator = com.chefSearch.model.listSubjectsWithProperty(propertyStarring);
...
//
//        /* RESTAURANTS */
//        Property propertyOwner = com.chefSearch.model.getProperty("http://dbpedia.org/ontology/owner");
//        ResIterator propertyOwnerIterator = com.chefSearch.model.listSubjectsWithProperty(propertyOwner);
